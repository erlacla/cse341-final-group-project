...
const createStatus = async (req, res) => {
  try {
    if (req.oidc.isAuthenticated()) {
      ...
      if (typeof data.bookId == "string" && !ObjectId.isValid(data.bookId)) {
      ...
      if (typeof data.checkedIn != "boolean") {
        failMessage +=
          "To create a new Status, enter a checkedIn boolean value.\n";
      }
      if (failMessage != "") {
        res.status(400);
        res.send(failMessage);
  ...
  try {
    if (req.oidc.isAuthenticated()) {
      ...
      if (typeof data.history.statusId != "string") {
        failMessage +=
          "To create a new book History, enter a statusId string.\n";
      }
      if (
      ...
      if (typeof data.history.accountId != "string") {
        failMessage +=
          "To create a new book History, enter an accountId string.\n";
      }
      if (
      ...
      if (typeof data.history.checkedOut != "string") {
        failMessage +=
          "To create a new book History, enter a checkedOut string.\n";
      }
      if (typeof data.history.checkedOut == "string") {
        const expression = new RegExp(
        ...
        if (!expression.test(data.history.checkedOut)) {
          failMessage +=
            "To create a new book History, enter a checkedOut string date format of YYYY-MM-DD.\n";
        }
      }
      if (typeof data.history.returnDate != "string") {
        failMessage +=
          "To create a new book History, enter a returnDate string.\n";
      }
      if (typeof data.history.returnDate == "string") {
        const expression = new RegExp(
          /\d{4}\-(0[1-9]|1[012])\-(0[1-9]|[12][0-9]|3[01])$/
        ...
        if (!expression.test(data.history.returnDate)) {
          failMessage +=
            "To create a new book History, enter a returnDate string date format of YYYY-MM-DD.\n";
        }
      }
      if (typeof data.history.checkedIn != "boolean") {
        failMessage +=
          "To create a new book History, enter a checkedIn boolean value.\n";
      }
      if (failMessage != "") {
        res.status(400);
        res.send(failMessage);
